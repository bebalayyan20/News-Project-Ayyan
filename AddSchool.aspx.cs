...
namespace NewsAF
{
    ...
    {
        SqlConnection cn = new SqlConnection("Data Source=(LocalDB)\\MSSQLLocalDB;AttachDbFilename=C:\\HA6\\NewsAF\\App_Data\\school.mdf;Integrated Security=True");
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            cn.Open();
            cmd.CommandText = "insert into [school](headline, date , location , image , description) values('" + TextBox1.Text + "','" + TextBox2.Text + "','" + TextBox3.Text + "','" + link + "','" + TextBox4.Text + "')";
            cmd.Connection = cn;
            cmd.ExecuteNonQuery();
