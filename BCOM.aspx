<%--<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPageUser.Master" AutoEventWireup="true" CodeBehind="BCOM.aspx.cs" Inherits="NewsAF.BCOM" %>--%>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <tr>
        ...
        <td class="text-center"><strong>
            <asp:Label ID="Label1" runat="server" style="font-size: xx-large" Text="Bachelor of Commerce"></asp:Label>
            </strong></td>
        <td>&nbsp;</td>
    </tr>
    <tr>
