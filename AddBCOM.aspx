<%@ Page Title="" Language="C#" MasterPageFile="~/AdminMaster.Master" AutoEventWireup="true" CodeBehind="AddBCOM.aspx.cs" Inherits="NewsAF.AddBCOM" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <form id="form1" runat="server">
    <table class="w-100" align="center">
        <tr>
            <td class="text-center" colspan="2"><strong>
                <asp:Label ID="Label1" runat="server" Text="Add BCOM News"></asp:Label>
                </strong></td>
        </tr>
        <tr>
            <td>
