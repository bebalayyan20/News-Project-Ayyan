<%@ Page Title="" Language="C#" MasterPageFile="~/AdminMaster.Master" AutoEventWireup="true" CodeBehind="AddBSCCS.aspx.cs" Inherits="NewsAF.AddBSCCS" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <form id="form1" runat="server">
    <table class="w-100" align="center">
        <tr>
            <td class="text-center" colspan="2"><strong>
                <asp:Label ID="Label1" runat="server" Text="Add BSCCS News"></asp:Label>
                </strong></td>
        </tr>
        <tr>
            <td>
